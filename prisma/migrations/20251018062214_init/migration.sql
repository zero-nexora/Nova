...
-- CreateEnum
CREATE TYPE "public"."RoleName" AS ENUM ('ADMIN', 'MANAGE_PRODUCT', 'MANAGE_CATEGORY', 'MANAGE_ROLE', 'CUSTOMER');

-- CreateEnum
CREATE TYPE "public"."PermissionName" AS ENUM ('CREATE', 'READ', 'UPDATE', 'DELETE');
...
-- CreateIndex
CREATE UNIQUE INDEX "Wishlists_product_id_key" ON "public"."Wishlists"("product_id");
