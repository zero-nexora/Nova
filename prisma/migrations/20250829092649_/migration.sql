-- CreateEnum
CREATE TYPE "public"."RoleName" AS ENUM ('ADMIN', 'CUSTOMER', 'STAFF');

-- CreateEnum
CREATE TYPE "public"."PermissionName" AS ENUM ('CREATE_PRODUCT', 'READ_PRODUCT', 'UPDATE_PRODUCT', 'DELETE_PRODUCT', 'CREATE_CATEGORY', 'READ_CATEGORY', 'UPDATE_CATEGORY', 'DELETE_CATEGORY', 'CREATE_ORDER', 'READ_ORDER', 'UPDATE_ORDER', 'DELETE_ORDER');
...
-- CreateIndex
CREATE INDEX "User_Permissions_user_id_permission_id_idx" ON "public"."User_Permissions"("user_id", "permission_id");
